...
<div class="container wall">
	<div align="center"  style="padding-top: 10% ">
		...
		<form action="check_login.php" method="post">
			<input required name="username" id="username" type="text" class="form-control form-control-sm" autocomplete="false" placeholder="Username" autofocus style="    width: 40%;">
			<input required name="password" id="password" type="password" style="margin-top:10px; width: 40%;" class="form-control form-control-sm" autocomplete="false" placeholder="Password" >
			<div style="padding-top:15px;     text-align: center;" align="right" >
				<button type="submit" class="myButton" style="cursor: pointer;" >Login</button>
			</div>
		</form>

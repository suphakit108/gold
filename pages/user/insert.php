	...
	<div id="wrapper">
		...
		<div id="page-wrapper">
			<div class="container-fluid">
				...
				<form action="index.php?app=user&action=add" method="post" >
					<!-- /.row -->
					<div class="row">
						<div class="col-lg-12">
													...
													<div class="row">
														<div class="col-lg-2">
															<div class="form-group">
																...
																<input id="user_username" name="user_username" class="form-control" autocomplete="off" required>
															</div>
														</div>
														<div class="col-lg-2">
															<div class="form-group">
																<label>password <font color="#F00"><b>*</b></font></label>
																<input id="user_password" name="user_password" class="form-control" autocomplete="off" required>
															</div>
														</div>
														...
														<div class="col-lg-2">
															<div class="form-group">
																...
																<input id="user_firstname" name="user_firstname" class="form-control" autocomplete="off" required>
															</div>
														</div>
														<div class="col-lg-2">
															<div class="form-group">
																<label>นามสกุล <font color="#F00"><b>*</b></font></label>
																<input id="user_lastname" name="user_lastname" class="form-control" autocomplete="off" required>
															</div>
														</div>
														<div class="col-lg-4">
															<div class="form-group">
																<label>เบอร์โทรศัพท์  <font color="#F00"><b>*</b></font></label>
																<input id="user_phone" name="user_phone"  type="tel" required    class="form-control" autocomplete="off" required>
															</div>
														</div>
														<div class="col-lg-4">
															<div class="form-group">
